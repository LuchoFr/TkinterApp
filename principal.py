...
def recibo():
    ...
    texto_recibo.insert(END,f'Costo del impuesto:\t\t\t{var_impuesto.get()}\n')
    texto_recibo.insert(END,f'Costo total:\t\t\t{var_total.get()}\n')
    texto_recibo.insert(END,f'*'*80+'\n')
    texto_recibo.insert(END,'Lo esperamos en su proxima visita')
...
#Panel comidas
panel_comidas=LabelFrame(panel_izquierdo,text='Bebidas',font=('Dosis',19,'bold'),bd=1,relief=FLAT,fg='azure4')
...
lista_bebida=['agua','soda','jugo','cola','vino1','vino2','cerveza1','cerveza2']
